...
const TDRTable = ({standardContactData, setStandardContactData, onSave, practicalData, setPracticalData, projectUnitData, setProjectUnitData, teachingRelatedDuties, setTeachingRelatedDuties}) => 
{
  ...
  const calculateTotalTDPlusTRD = () => {
    return calculateTotalTD() + calculateTotalTRD();
  };
      ...
      <Table compact celled striped structured>
        <Table.Header>
          ...
          <Table.Row style={{ fontSize: '16px', textAlign: 'center' }}>
            ...
            <Table.HeaderCell rowSpan="3">Tuition Hours</Table.HeaderCell>
            <Table.HeaderCell rowSpan="3">Frequency</Table.HeaderCell>
            <Table.HeaderCell rowSpan="3">Total Classes</Table.HeaderCell>
        ...
        <Table.Body>
                  <Table.Row>
                      ...
                      <Table.Cell contentEditable colSpan="1" style={{ fontSize: '16px', textAlign: 'center' }} onBlur={(e) => handleTRDChange(0, e.target.textContent)}>{teachingRelatedDuties[0]}</Table.Cell>
                  </Table.Row>
                  <Table.Row>
                      <Table.Cell colSpan="5" style={{ fontSize: '16px', textAlign: 'left', fontWeight: 'bold' }}>Preparation</Table.Cell>
                      <Table.Cell contentEditable colSpan="1" style={{ fontSize: '16px', textAlign: 'center' }} onBlur={(e) => handleTRDChange(1, e.target.textContent)}>{teachingRelatedDuties[1]}</Table.Cell>
                  </Table.Row>
                  <Table.Row>
                      <Table.Cell colSpan="5" style={{ fontSize: '16px', textAlign: 'left', fontWeight: 'bold' }}>Consultation</Table.Cell>
                      <Table.Cell contentEditable colSpan="1" style={{ fontSize: '16px', textAlign: 'center' }} onBlur={(e) => handleTRDChange(2, e.target.textContent)}>{teachingRelatedDuties[2]}</Table.Cell>
                  </Table.Row>
                  <Table.Row>
                      <Table.Cell colSpan="5" style={{ fontSize: '16px', textAlign: 'left', fontWeight: 'bold' }}>Marking</Table.Cell>
                      <Table.Cell contentEditable colSpan="1" style={{ fontSize: '16px', textAlign: 'center' }} onBlur={(e) => handleTRDChange(3, e.target.textContent)}>{teachingRelatedDuties[3]}</Table.Cell>
                  </Table.Row>
                  <Table.Row>
                      <Table.Cell colSpan="5" style={{ fontSize: '16px', textAlign: 'left', fontWeight: 'bold' }}>Moderation</Table.Cell>
                      <Table.Cell contentEditable colSpan="1" style={{ fontSize: '16px', textAlign: 'center' }} onBlur={(e) => handleTRDChange(4, e.target.textContent)}>{teachingRelatedDuties[4]}</Table.Cell>
                  </Table.Row>
                  <Table.Row>
                      <Table.Cell colSpan="5" style={{ fontSize: '16px', textAlign: 'left', fontWeight: 'bold' }}>Co-assessor duties</Table.Cell>
                      <Table.Cell contentEditable colSpan="1" style={{ fontSize: '16px', textAlign: 'center' }} onBlur={(e) => handleTRDChange(5, e.target.textContent)}>{teachingRelatedDuties[5]}</Table.Cell>
                  </Table.Row>
                  <Table.Row>
                      <Table.Cell colSpan="5" style={{ fontSize: '16px', textAlign: 'left', fontWeight: 'bold' }}>Other e.g.</Table.Cell>
                      <Table.Cell contentEditable colSpan="1" style={{ fontSize: '16px', textAlign: 'center' }} onBlur={(e) => handleTRDChange(6, e.target.textContent)}>{teachingRelatedDuties[6]}</Table.Cell>
                  </Table.Row>
                  <Table.Row>
        ...
        <Table.Header>
            <Table.Row>
                ...
                <Table.HeaderCell style={{ textAlign: 'center', fontSize: '16px', fontWeight: 'bold' }}>{calculateTotalTDPlusTRD()}</Table.HeaderCell>
            </Table.Row>
        </Table.Header>
