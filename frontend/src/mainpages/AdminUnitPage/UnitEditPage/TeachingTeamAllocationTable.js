...
setPracticalFieldworkAllocation, projectUnitsAllocation, setProjectUnitsAllocation, teachingDutiesAllocation, setTeachingDutiesAllocation, unit, 
standardContactData, practicalData, teachingRelatedDuties, projectUnitData}) => {
  ...
  //calculating total teaching delivery allocations for the unit
  ...
  //calculating total allocations for the staff members
  ...
  return (
    <div className="teaching-table-two">
      <Table compact celled striped structured>
        <Table.Header>
          ...
          <Table.Row style={{ fontSize: '16px', textAlign: 'center' }}>
            <Table.HeaderCell contentEditable data-placeholder="Enter staff name" onBlur={(e) => handleStaffNameBlur(0, e)}>
              {unit.teachingStaff && unit.teachingStaff.length > 0 && unit.teachingStaff[0] ? unit.teachingStaff[0].staffName : ''}
            </Table.HeaderCell>

            <Table.HeaderCell contentEditable data-placeholder="Enter staff name" onBlur={(e) => handleStaffNameBlur(1, e)}>
              {unit.teachingStaff && unit.teachingStaff.length > 1 && unit.teachingStaff[1] ? unit.teachingStaff[1].staffName : ''}
            </Table.HeaderCell>

            <Table.HeaderCell contentEditable data-placeholder="Enter staff name" onBlur={(e) => handleStaffNameBlur(2, e)}>
              {unit.teachingStaff && unit.teachingStaff.length > 2 && unit.teachingStaff[2] ? unit.teachingStaff[2].staffName : ''}
            </Table.HeaderCell>

            <Table.HeaderCell contentEditable data-placeholder="Enter staff name" onBlur={(e) => handleStaffNameBlur(3, e)}>
              {unit.teachingStaff && unit.teachingStaff.length > 3 && unit.teachingStaff[3] ? unit.teachingStaff[3].staffName : ''}
            </Table.HeaderCell>

            <Table.HeaderCell contentEditable data-placeholder="Enter staff name" onBlur={(e) => handleStaffNameBlur(4, e)}>
              {unit.teachingStaff && unit.teachingStaff.length > 4 && unit.teachingStaff[4] ? unit.teachingStaff[4].staffName : ''}
            </Table.HeaderCell>
        ...
        <Table.Body>
          {/* Iterate through columns in the practicalFieldworkAllocation array */}
    ...
    <Table.Body>
          {/* Iterate through columns in the teachingDuties array */}
